...
# Использование: dump-epf.ps1 <XML_FILE> <EPF_FILE>
#   XML_FILE — корневой XML-файл для выгрузки (папка создаётся автоматически)
#   EPF_FILE — путь к исходной обработке .epf/.erf
