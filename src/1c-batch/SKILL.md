---
name: 1c-batch
description: "Пакетные операции с платформой 1С:Предприятие 8. Сборка/разборка внешних обработок (.epf/.erf) в XML, загрузка/выгрузка конфигураций и расширений (XML и бинарные .cf/.cfe), запуск предприятия и конфигуратора. Используй когда нужно: собрать или разобрать обработку/отчёт, загрузить или выгрузить конфигурацию в XML, собрать или загрузить файл .cf/.cfe, работать с расширениями 1С, запустить 1С:Предприятие или конфигуратор."
---
